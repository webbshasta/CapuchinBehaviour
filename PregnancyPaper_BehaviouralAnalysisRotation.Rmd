...
```{r}
df16 <- read.csv('~/Desktop/PregnancyPaper2019/BehaviouralAnalysis/BehaviorData/CSVs/2016_BehData.csv')
...
```{r}
df17 <- read.csv('~/Desktop/PregnancyPaper2019/BehaviouralAnalysis/BehaviorData/CSVs/2017_BehData.csv')
...
```{r}
df18 <- read.csv('~/Desktop/PregnancyPaper2019/BehaviouralAnalysis/BehaviorData/CSVs/2018_BehData.csv') 
...
write.csv(combinedDF, "~/Desktop/PregnancyPaper2019/BehaviouralAnalysis/BehaviorData/CSVs/combinedDFclean.csv")
```
...
```{r}
combinedDF <- read.csv("~/Desktop/PregnancyPaper2019/BehaviouralAnalysis/BehaviorData/CSVs/combinedDFclean.csv")
...
```{r}
rotationTable <- read.csv("~/Desktop/PregnancyPaper2019/BehaviouralAnalysis/BehaviorData/rotationDate.csv")
...
combinedDF <- combinedDF %>% #1618 rows
              left_join(., rotationTable, by = c("DateOf" = "DateOfYear")) #;View(combinedDF) #ensure that the left join worked correctly and no duplicated rows were produced
```
...
```{r}
dominanceTable <- read.csv("~/Desktop/PregnancyPaper2019/BehaviouralAnalysis/EcologicalDataCensus/DominanceScale16_18.csv")
...
```{r}
combinedDF <- combinedDF %>% #1618 rows
              dplyr::select(-X, -Animal.y, -StartYear, -EndYear)
...
```{r}
combinedDF <- combinedDF %>% #1618 rows
              dplyr::select(-Animal.y, -AnimalCode) %>%
...
```{r}
fruitBiomassTable <- as.data.frame(read.csv("~/Desktop/PregnancyPaper2019/BehaviouralAnalysis/EcologicalDataCensus/MonthlyFruitBiomass.csv"))
...
```{r}
dfz <- read.csv("~/Desktop/PregnancyPaper2019/BehaviouralAnalysis/BehaviorData/dfz21April.csv")
...
ggsave("~/Desktop/PregnancyPaper2019/BehaviouralAnalysis/Figures/SI_figure_foraging.pdf", plot = SI_figure_foraging, width = 4, height = 6)
